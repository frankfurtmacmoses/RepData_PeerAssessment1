	...
	public DirsOptionPane()
	{
		...
		add.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				chooser.setTitle(jEdit.getProperty(MESSAGE + "sourceTreeTitle"));
		...
		addArchive.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				chooser.setTitle(jEdit.getProperty(MESSAGE + "sourceArchiveTitle"));
				chooser.setVisible(true);
				if (chooser.getSelectedFiles() == null)
					return;
		...
		tagArchive.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				int i = archives.getSelectedIndex();
				if (i >= 0) {
					String archive = (String) archivesModel.getElementAt(i);
					CtagsInterfacePlugin.refreshOrigin(OriginType.ARCHIVE, archive);
				}
			}
		});
	}
