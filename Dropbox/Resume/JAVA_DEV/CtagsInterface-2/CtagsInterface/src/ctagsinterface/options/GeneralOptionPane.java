...
public class GeneralOptionPane extends AbstractOptionPane {
	...
	static public final String PREVIEW_FOLLOW = OPTION + "previewFollow";
	static public final String PREVIEW_DELAY = OPTION + "previewDelay";
	static public final String PREVIEW_GUTTER = OPTION + "previewGutter";
	static public final String PREVIEW_COLLAPSE_FOLDS = OPTION + "previewCollapseFolds";
	static public final String PREVIEW_CTAGS_SIDEKICK = OPTION + "previewCtagsSideKick";
	...
	JCheckBox previewFollow;
	JCheckBox previewGutter;
	JCheckBox previewCollapseFolds;
	JCheckBox previewCtagsSideKick;
	...
	public GeneralOptionPane() {
		...
		previewFollow = new JCheckBox(jEdit.getProperty(MESSAGE + "previewFollow"),
				jEdit.getBooleanProperty(PREVIEW_FOLLOW));
		previewPanel.add(previewFollow);
		...
		previewGutter = new JCheckBox(jEdit.getProperty(MESSAGE + "previewGutter"),
				getPreviewGutter());
		previewGutter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				if (!previewGutter.isSelected()) {
					previewCollapseFolds.setSelected(false);
					previewCollapseFolds.setEnabled(false);
					previewCtagsSideKick.setSelected(false);
					previewCtagsSideKick.setEnabled(false);
				} else {
					previewCollapseFolds.setEnabled(true);
					previewCtagsSideKick.setEnabled(true);
				}
			}
		});
		previewPanel.add(previewGutter);
		previewCollapseFolds = new JCheckBox(jEdit.getProperty(MESSAGE + "previewCollapseFolds"),
				getPreviewCollapseFolds());
		previewPanel.add(previewCollapseFolds);
		previewCtagsSideKick = new JCheckBox(jEdit.getProperty(MESSAGE + "previewCtagsSideKick"),
				getPreviewCtagsSideKick());
		previewPanel.add(previewCtagsSideKick);
	...
	protected void _save() {
		...
		jEdit.setBooleanProperty(PREVIEW_FOLLOW, previewFollow.isSelected());
		jEdit.setBooleanProperty(PREVIEW_GUTTER, previewGutter.isSelected());
		jEdit.setBooleanProperty(PREVIEW_COLLAPSE_FOLDS, previewCollapseFolds.isSelected());
		jEdit.setBooleanProperty(PREVIEW_CTAGS_SIDEKICK, previewCtagsSideKick.isSelected());
	...
	public static boolean getPreviewFollow() {
		return jEdit.getBooleanProperty(PREVIEW_FOLLOW, true);
	}
	public static void setPreviewFollow(boolean follow) {
		jEdit.setBooleanProperty(PREVIEW_FOLLOW, follow);
	}
	public static boolean getPreviewGutter() {
		return jEdit.getBooleanProperty(PREVIEW_GUTTER, false);
	}
	public static void setPreviewGutter(boolean previewGutter) {
		jEdit.setBooleanProperty(PREVIEW_GUTTER, previewGutter);
	}
	public static boolean getPreviewCollapseFolds() {
		return jEdit.getBooleanProperty(PREVIEW_COLLAPSE_FOLDS, false);
	}
	public static void setPreviewCollapseFolds(boolean collapseFolds) {
		jEdit.setBooleanProperty(PREVIEW_COLLAPSE_FOLDS, collapseFolds);
	}
	public static boolean getPreviewCtagsSideKick() {
		return jEdit.getBooleanProperty(PREVIEW_CTAGS_SIDEKICK, false);
	}
	public static void setPreviewCtagsSideKick(boolean ctagsSideKick) {
		jEdit.setBooleanProperty(PREVIEW_CTAGS_SIDEKICK, ctagsSideKick);
	}
